...
![img](/users/liuliu/desktop/2.png)
...
![](/users/liuliu/desktop/3.png)

###0x7c00处设置断点并测试
使用`b *0x7c00`命令在0x7c00处设置断点，`c`命令运行，成功断下。

![](/users/liuliu/desktop/4.png)
...
根据知道书提示，查看muu.h中的SETGATE宏，填充idt数组内容。
